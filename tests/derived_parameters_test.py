...
class TestVref(unittest.TestCase, NodeTest):
    ...
    def setUp(self):
        ...
        self.apps = buildsections('Approach', (2, 30), (66, 90))
    ...
    def test_can_operate(self):
        ...
        # Embraer:
        self.assertTrue(self.node_class.can_operate(
            ('Airspeed', 'V1-Vref', 'Approach And Landing', 'Approach'),
        ))
    ...
    def test_derive__embraer(self):
        ...
        node = self.node_class()
        node.derive(self.airspeed, v1_vref, None, self.app_lands, self.apps)
